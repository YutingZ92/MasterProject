...
# Modified by Yuting Zhang for RINA NFV webnair using Ryu
# Sep 2019
...
vnf3 = str(config.get('general', 'vnf3'))
vnf4 = str(config.get('general', 'vnf4'))
vnf1_interface = int(config.get('general', 'vnf1_interface'))
vnf2_interface = int(config.get('general', 'vnf2_interface'))
vnf3_interface = int(config.get('general', 'vnf3_interface'))
vnf4_interface = int(config.get('general', 'vnf4_interface'))
